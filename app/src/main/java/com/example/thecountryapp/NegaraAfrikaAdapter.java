...
public class NegaraAfrikaAdapter extends RecyclerView.Adapter<NegaraAfrikaAdapter.MyViewHolder> {

    private Context mContext ;
    private List<NegaraAfrika> mData ;


    public NegaraAfrikaAdapter(Context mContext, List<NegaraAfrika> mData) {
