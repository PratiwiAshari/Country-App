...
public class NegaraAmerikaAdapter extends RecyclerView.Adapter<NegaraAmerikaAdapter.MyViewHolder> {

    private Context mContext ;
    private List<NegaraAmerika> mData ;


    public NegaraAmerikaAdapter(Context mContext, List<NegaraAmerika> mData) {
