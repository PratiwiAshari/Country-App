...
public class NegaraAsiaAdapter extends RecyclerView.Adapter<NegaraAsiaAdapter.MyViewHolder> {

    private Context mContext ;
    private List<NegaraAsia> mData ;


    public NegaraAsiaAdapter(Context mContext, List<NegaraAsia> mData) {
