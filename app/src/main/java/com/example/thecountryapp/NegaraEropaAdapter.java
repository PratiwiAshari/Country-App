...
public class NegaraEropaAdapter extends RecyclerView.Adapter<NegaraEropaAdapter.MyViewHolder> {

    private Context mContext ;
    private List<NegaraEropa> mData ;


    public NegaraEropaAdapter(Context mContext, List<NegaraEropa> mData) {
